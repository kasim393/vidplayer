...
const speedHeading = document.getElementById("speedHeading");
...
// toggleSetting toggles setting
function toggleSetting() {
  if (settingBox.style.display == "none") {
    settingBox.style.display = "block";
  } else settingBox.style.display = "none";
  console.log(settingBox);
}
// toggleSetting toggles quality
function toggleQuality() {
  qualityBox.style.display = "block";
  settingBox.style.display = "none";
}
// toggleSetting toggles quality
function toggleQualityHeading() {
  qualityBox.style.display = "none";
  settingBox.style.display = "block";
}
// toggleSetting toggles speed
function toggleSpeed() {
  speedBox.style.display = "block";
  settingBox.style.display = "none";
}
// toggleSetting toggles speed
function toggleSpeedHeading() {
...
qualityItem.addEventListener("click", toggleQuality);
qualityHeading.addEventListener("click", toggleQualityHeading);
speedItem.addEventListener("click", toggleSpeed);
speedHeading.addEventListener("click", toggleSpeedHeading);
